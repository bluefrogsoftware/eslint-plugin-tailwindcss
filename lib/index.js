...
function parseNodeRecursive(rootNode, childNode, cb, skipConditional = false, isolate = false, ignoredKeys = []) {
  ...
  if (childNode === null) {
    ...
    classNames = removeDuplicatesFromArray_default(classNames);
...
var init_customConfig = __esm({
  async "src/util/customConfig.ts"() {
    "use strict";
    try {
...
var INVALID_CLASSNAMES_ORDER_MSG, contextFallbackCache, classnames_order_default;
var init_classnames_order = __esm({
  async "src/rules/classnames-order.ts"() {
    "use strict";
    init_ast();
    await init_customConfig();
    init_docsUrl();
    init_parser();
    init_order();
...
var init_enforces_negative_arbitrary_values = __esm({
  async "src/rules/enforces-negative-arbitrary-values.ts"() {
    "use strict";
    init_ast();
    await init_customConfig();
    init_docsUrl();
...
var init_enforces_shorthand = __esm({
  async "src/rules/enforces-shorthand.ts"() {
    "use strict";
    init_groups();
    init_ast();
    await init_customConfig();
...
var CLASSNAME_NOT_NEEDED_MSG, CLASSNAMES_NOT_NEEDED_MSG, CLASSNAME_CHANGED_MSG, OPACITY_CLASS_DEPRECATED_MSG, migration_from_tailwind_2_default;
var init_migration_from_tailwind_2 = __esm({
  async "src/rules/migration-from-tailwind-2.ts"() {
    "use strict";
    init_ast();
    await init_customConfig();
    init_docsUrl();
    ...
    migration_from_tailwind_2_default = {
      meta: {
        docs: {
          ...
          recommended: true,
          url: docsUrl_default("migration-from-tailwind-2")
        },
        messages: {
      ...
      create: function(context) {
        ...
        const parseForObsoleteClassNames = (node, arg = null) => {
          ...
          const filtered = classNames.filter((cls) => {
            const suffix2 = groupMethods_default.getSuffix(cls, mergedConfig2.separator);
...
var ARBITRARY_VALUE_DETECTED_MSG, no_arbitrary_value_default;
var init_no_arbitrary_value = __esm({
  async "src/rules/no-arbitrary-value.ts"() {
    "use strict";
    init_ast();
    await init_customConfig();
    init_docsUrl();
    ...
    no_arbitrary_value_default = {
      meta: {
        docs: {
          ...
          category: "Best Practices",
          recommended: false,
          url: docsUrl_default("no-arbitrary-value")
        },
        messages: {
      ...
      create: function(context) {
        ...
        const parseForArbitraryValues = (node, arg = null) => {
          ...
          classNames.forEach((cls, idx) => {
            const parsed = groupMethods_default.parseClassname(cls, [], mergedConfig2, idx);
...
var init_no_contradicting_classname = __esm({
  async "src/rules/no-contradicting-classname.ts"() {
    "use strict";
    init_groups();
    init_ast();
    await init_customConfig();
...
var lastClassFromSelectorRegexp, cssFilesInfos, lastUpdate, classnamesFromFiles, generateClassnamesListSync, cssFiles_default;
var init_cssFiles = __esm({
  "src/util/cssFiles.ts"() {
    ...
    generateClassnamesListSync = (patterns, refreshRate = 5e3) => {
      ...
      return removeDuplicatesFromArray_default(classnamesFromFiles);
    };
...
import { createContext as createContextFallback2 } from "tailwindcss/lib/lib/setupContextUtils";
var CUSTOM_CLASSNAME_DETECTED_MSG, getGroupNameRegex, contextFallbackCache2, no_custom_classname_default;
var init_no_custom_classname = __esm({
  async "src/rules/no-custom-classname.ts"() {
    "use strict";
    init_groups();
    init_ast();
    init_cssFiles();
    ...
    getGroupNameRegex = (prefix = "") => new RegExp(`^${escapeRegex(prefix)}(group|peer)/[\\w\\$\\#\\@\\%\\^\\&\\*\\_\\-]+$`, "i");
...
var init_no_unnecessary_arbitrary_value = __esm({
  async "src/rules/no-unnecessary-arbitrary-value.ts"() {
    "use strict";
    init_groups();
    init_ast();
    await init_customConfig();
...
var init_rules2 = __esm({
  async "src/rules/index.ts"() {
    "use strict";
    await init_classnames_order();
    await init_enforces_negative_arbitrary_values();
    await init_enforces_shorthand();
    await init_migration_from_tailwind_2();
    await init_no_arbitrary_value();
    await init_no_contradicting_classname();
    await init_no_custom_classname();
    await init_no_unnecessary_arbitrary_value();
    rules = {
